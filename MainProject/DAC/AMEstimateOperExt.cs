...
{
    public class AMEstimateOperExt : PXCacheExtension<AMEstimateOper>
    {
        #region UsrSelected
        [PXBool]
        ...
        public abstract class usrSelected : BqlBool.Field<usrSelected> { }
        #endregion
        #region UsrLeadDays
        [PXDBInt]
        ...
        [PXSelector(typeof(Search<ArcAMWCLocations.locationID,
            Where<ArcAMWCLocations.active, Equal<True>,
                And<ArcAMWCLocations.wCID, Equal<Current<AMEstimateOper.workCenterID>>>>>),
